# Generated by Django 2.1.7 on 2020-08-10 13:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('Lesson', 'Lesson'), ('Exam', 'Exam'), ('Quize', 'Quize')], max_length=255)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='language',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='language_grade', to='models_app.LanguageModel'),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='quizematchingquestionmodel',
            unique_together={('instruction', 'answer'), ('instruction', 'number'), ('instruction', 'questionText')},
        ),
        migrations.AlterUniqueTogether(
            name='quizematchingposibleanswersmodels',
